<div class="col-md-2 col-lg-2 col-12">
    <h4 class="h4 font-weight-400"><?php echo e(__('Landingpage')); ?></h4>
    <div class="card">
        <div class="card-body" style="min-height: 230px;">
            ...
            <div class="d-flex justify-content-between">
                <a href="#!" class="btn btn-sm btn-light-primary w-100 cp_link"
                    data-link="<?php echo e(url('/')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="" data-bs-original-title="Click to copy site link">
                    <?php echo e('Site Link'); ?>
...
</div><?php /**PATH C:\Users\Espacegamers\Documents\lumex\packages\workdo\LandingPage\src\Providers/../Resources/views/layouts/dash_qr.blade.php ENDPATH**/ ?>