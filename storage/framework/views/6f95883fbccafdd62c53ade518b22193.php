                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-primary">
                                        <?php echo e(\Workdo\Account\Entities\AccountUtility::countCustomers()); ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-info">
                                        <?php echo e(\Workdo\Account\Entities\AccountUtility::countVendors()); ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-danger">
                                        <?php echo e(\Workdo\Account\Entities\AccountUtility::countBills()); ?> </h3>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($bill->status == 0): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-secondary"><?php echo e(__(\Workdo\Account\Entities\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 1): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-warning"><?php echo e(__(\Workdo\Account\Entities\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 2): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-danger"><?php echo e(__(\Workdo\Account\Entities\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 3): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-info"><?php echo e(__(\Workdo\Account\Entities\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 4): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-success"><?php echo e(__(\Workdo\Account\Entities\Bill::$statues[$bill->status])); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\lumex\packages\workdo\Account\src\Providers/../Resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>