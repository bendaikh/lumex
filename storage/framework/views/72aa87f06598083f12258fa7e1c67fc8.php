                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center mb-2 mt-2">
                            ...
                            <div class="ms-3 mb-3 mt-3">
                                <h6 class="ml-4"><?php echo e(__('Total Customers')); ?></h6>
                            </div>
                        </div>

                        <div class="number-icon ms-3 mb-3 mt-3">
                            <h3><?php echo e($user->total_user); ?></h3>
                        </div>
                        <div class="ms-3 mb-3 mt-3">
                            <h6><?php echo e(__('Paid Customers')); ?> : <?php echo e($user['total_paid_user']); ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3">
                            <h3><?php echo e($user->total_orders); ?></h3>
                        </div>
                        <div class="ms-3 mb-3 mt-3">
                            <h6><?php echo e(__('Order Amount')); ?> : <span
                                    class="text-dark"><?php echo e(super_currency_format_with_sym($user['total_orders_price'])); ?></span>
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3">
                            <h3><?php echo e($user->total_plans); ?></h3>
                        </div>
                        <div class="ms-3 mb-3 mt-3">
                            <h6><?php echo e(__('Popular Plan')); ?> : <span
                                    class="text-primary"><?php echo e(!empty($user->popular_plan) ? $user->popular_plan->name : ''); ?></span>
                            </h6>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\lumex\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>