...
<?php $__env->startSection('page-action'); ?>
    <div>
        ...
        <?php if (app('laratrust')->hasPermission('user import')) : ?>
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-title="<?php echo e(__('Import Customers')); ?>"
                data-url="<?php echo e(route('users.file.import')); ?>" data-toggle="tooltip" title="<?php echo e(__('Import Customers')); ?>"><i
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::text('name', isset($_GET['name']) ? $_GET['name'] : null, ['class' => 'form-control','placeholder' => 'Enter Name'])); ?>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::select('role', $roles, isset($_GET['role']) ? $_GET['role'] : '', ['class' => 'form-control select', 'placeholder' => 'All'])); ?>
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-sm btn-danger" data-toggle="tooltip"
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                        ...
                                        <?php if(Auth::user()->type == "super admin"): ?>
                                            ...
                                            <a href="#!" data-url="<?php echo e(route('upgrade.plan',$user->id)); ?>"
                                                data-ajax-popup="true" data-size="xl" class="dropdown-item"
                                                data-title="<?php echo e(__('Upgrade Plan')); ?>"
                                                data-bs-original-title="<?php echo e(__('Upgrade Plan')); ?>">
                                                <i class="ti ti-trending-up"></i>
                                                <span> <?php echo e(__('Upgrade Plan')); ?></span>
                                            </a>
                                        <?php endif; ?>
                            ...
                            <div class="mt-4">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-6 text-center">
                                        <span class="d-block font-bold mb-0"><?php echo e(!empty($user->plan) ? (!empty($user->plan->name) ? $user->plan->name :'Basic Plan'):'Plan Not Activated'); ?></span>
                                    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\lumex\resources\views/users/index.blade.php ENDPATH**/ ?>