        ...
        <?php if((module_is_active('ProductService') && module_is_active('Account')) || module_is_active('Taskly')): ?>
            <?php if (app('laratrust')->hasPermission('proposal manage')) : ?>
                ...
                <a href="<?php echo e(route('proposal.stats.view')); ?>" data-bs-toggle="tooltip"
                    data-bs-original-title="<?php echo e(__('Quick Stats')); ?>" class="btn btn-sm btn-primary btn-icon">
                    ...
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <a href="#!" class="btn btn-sm btn-primary"
                                data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" id="applyfilter"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\lumex\resources\views/proposal/index.blade.php ENDPATH**/ ?>