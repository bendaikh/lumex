            ...
            ->editColumn('document', function (Document $documents) {
                if (!empty($documents->document)) {
                    ...
                    $html = '<div class="action-btn bg-primary ms-2">
                                 <a class="mx-3 btn btn-sm align-items-center" href="' . $get_file . '" download>
                                     <i class="ti ti-download text-white">
                                     </i>
                                  </a>
                             </div>
                             <div class="action-btn bg-secondary ms-2">
                                 <a class="mx-3 btn btn-sm align-items-center" href="' . $get_file . '" target="_blank">
                                     <i class="ti ti-crosshair text-white" data-bs-toggle="tooltip" data-bs-original-title="' . __('Preview') . '">
                                     </i>
                                 </a>
                             </div>';
