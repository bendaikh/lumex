{{ Form::open(['url' => 'attendance', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('clock_in', __('Clock In'), ['class' => 'col-form-label']) }}<x-required></x-required>
                {{ Form::time('clock_in', null, ['class' => 'form-control timepicker', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('clock_out', __('Clock Out'), ['class' => 'col-form-label']) }}<x-required></x-required>
