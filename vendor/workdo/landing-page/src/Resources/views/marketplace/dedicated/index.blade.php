                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div id="p1" class="col-auto text-end text-primary h3">
                                        <a image-url="{{ get_file('vendor/workdo/landing-page/src/Resources/assets/infoimages/dedicated.png') }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div id="p1" class="col-auto text-end text-primary h3">
                                        <a image-url="{{ get_file('vendor/workdo/landing-page/src/Resources/assets/infoimages/dedicated.png') }}" data-id="1"
