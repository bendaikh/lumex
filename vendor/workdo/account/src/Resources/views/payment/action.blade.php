@if (Laratrust::hasPermission('expense payment delete') || Laratrust::hasPermission('expense payment edit'))
    @permission('expense payment edit')
        <div class="action-btn bg-info ms-2">
            <a class="mx-3 btn btn-sm align-items-center" data-url="{{ route('payment.edit', $payment->id) }}"
    ...
    @permission('expense payment delete')
        <div class="action-btn bg-danger ms-2">
            ...
            @method('DELETE')
            <a class="mx-3 btn btn-sm  align-items-center bs-pass-para show_confirm" data-bs-toggle="tooltip" title=""
