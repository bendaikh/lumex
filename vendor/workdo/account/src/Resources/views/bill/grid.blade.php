    ...
    <div class="row">
        ...
        <div class="col-sm-12">
                                    ...
                                    <div class="col-10">
                                        <h6 class="mb-0">
                                            @if (Laratrust::hasPermission('bill show'))
                                                <a href="{{route('bill.show',\Crypt::encrypt($bill->id))}}">{{ Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id) }}</a>
                                            @else
            ...
            @auth('web')
                @permission('bill create')
                <div class="col-md-3">
                    <a href="{{ route('bills.create', 0) }}" class="btn-addnew-project"
