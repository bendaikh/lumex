                                        ...
                                        @foreach ($customFields as $key => $field)
                                            <div class="col-md-3 col-sm-3 mt-4">
                                                <div class="d-flex align-items-start">
                                                    @if ($key % 4 === 0)
                                                        <div
                                                            class="theme-avtar bg-success {{ $field->type == 'textarea' && !empty($deal->customField[$field->id]) ? 'mt-2' : '' }}">
                                                    ...
                                                    @elseif($key % 4 === 1)
                                                        <div
                                                            class="theme-avtar bg-info {{ $field->type == 'textarea' && !empty($deal->customField[$field->id]) ? 'mt-2' : '' }}">
                                                            <i class="ti ti-circle-plus"></i>
                                                        </div>
                                                        <div class="ms-2">
                                                            <strong>{{ Str::ucfirst($field->name) }}</strong><br>
                                                    ...
                                                    @elseif($key % 4 === 2)
                                                        <div
                                                            class="theme-avtar bg-warning {{ $field->type == 'textarea' && !empty($deal->customField[$field->id]) ? 'mt-2' : '' }}">
                                                            <i class="ti ti-circle-plus"></i>
                                                        </div>
                                                        <div class="ms-2">
                                                            <strong>{{ Str::ucfirst($field->name) }}</strong><br>
                                                    ...
                                                    @elseif($key % 4 === 3)
                                                        <div
                                                            class="theme-avtar bg-danger {{ $field->type == 'textarea' && !empty($deal->customField[$field->id]) ? 'mt-2' : '' }}">
                                                            <i class="ti ti-circle-plus"></i>
                                                        </div>
                                                        <div class="ms-2">
                                                            <strong>{{ Str::ucfirst($field->name) }}</strong><br>
