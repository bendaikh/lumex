...
class Module
{
    ...
    {
        $path = base_path('vendor/workdo/' . $name . '/module.json');
        if (!File::exists($path)) {
            return false;
        }
        ...
        return Cache::rememberForever(
            ...
            function () use ($name) {
                if ($name === 'general') {
                    ...
                    $addonJson = $this->json($this->addon ? $this->addon->package_name : $name);
                    if ($addonJson) {
    ...
    public function getPath()
    {
        ...
        return base_path('vendor/workdo/' . $this->package_name);
    }
