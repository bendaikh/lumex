    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('status', function (CustomDomainRequest $custom_domain_request) {
                ...
                {
                    return '<span class="badge fix_badges bg-danger p-2 px-3 rounded">'. \App\Models\CustomDomainRequest::$statues[$custom_domain_request->status] .'</span>';
                }
                elseif($custom_domain_request->status == 1){
                    return '<span class="badge fix_badges bg-primary p-2 px-3 rounded">'. \App\Models\CustomDomainRequest::$statues[$custom_domain_request->status] .'</span>';
                }
                elseif($custom_domain_request->status == 2){
                    return '<span class="badge fix_badges bg-warning p-2 px-3 rounded">'. \App\Models\CustomDomainRequest::$statues[$custom_domain_request->status] .'</span>';
                }
            })
