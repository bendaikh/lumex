    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('action', function (EmailTemplate $email_template) {
                ...
                return '<div class="action-btn bg-warning ms-2">
                                        <a href="' . $url . '" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="' . __('View') . '">
