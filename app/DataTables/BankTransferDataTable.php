        ...
        ->addIndexColumn()
            ...
            ->editColumn('status', function (BankTransferPayment $bank_transfer_payment) {
                if ($bank_transfer_payment->status == 'Approved') {
                    $html = '<span class="bg-success p-1 px-3 rounded text-white">' . ucfirst($bank_transfer_payment->status) . '</span>';
                } elseif ($bank_transfer_payment->status == 'Pending') {
                    $html = '<span class="bg-warning p-1 px-3 rounded text-white">' . ucfirst($bank_transfer_payment->status) . '</span>';
                } else {
                    $html =  '<span class="bg-danger p-1 px-3 rounded text-white">' . ucfirst($bank_transfer_payment->status) . '</span>';
                }
