@permission('debitnote edit')
    <div class="action-btn bg-primary ms-2">
        <a data-url="{{ route('bill.debit-custom.edit', [$customdebitNote->bill, $customdebitNote->id]) }}" data-ajax-popup="true"
            data-title="{{ __('Edit Debit Note') }}" href="#" class="mx-3 btn btn-sm align-items-center"
...
@permission('debitnote delete')
    <div class="action-btn bg-danger ms-2">
        ...
        <a href="#" class="mx-3 btn btn-sm align-items-center show_confirm" data-bs-toggle="tooltip"
