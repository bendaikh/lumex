    ...
    <div class="p-3 border-bottom accordion-header">
        <div class="row">
            ...
            <div id="p1" class="col-auto text-end text-primary h3">
                <a image-url="{{ get_file('vendor/workdo/landing-page/src/Resources/assets/infoimages/featuresections.png') }}" data-id="1"
...
<div class="border mb-5">
    <div class="p-3 border-bottom accordion-header">
        <div class="row align-items-center">
            ...
            <div id="p1" class="col-auto text-end text-primary h3">
                <a image-url="{{ get_file('vendor/workdo/landing-page/src/Resources/assets/infoimages/featurecards.png') }}"
                   data-url="{{ route('info.image.view',['landingpage','features']) }}" class="view-images pt-2">
                    <i class="ti ti-info-circle pointer"></i>
                </a>
            </div>
