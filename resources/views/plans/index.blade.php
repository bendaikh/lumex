                            ...
                            <div class="product-img">
                                ...
                                <div class="checkbox-custom">
                                    <div class="btn-group card-option">
                                        <button type="button" class="btn" data-ajax-popup="true" data-size="md" data-title="{{ __('Customize Logo And Name') }}"  data-url="{{ route('add-one.detail',$module->name) }}" data-bs-toggle="tooltip"  data-bs-original-title="{{ __('Module Setting') }}">
