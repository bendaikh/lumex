                                ...
                                <div class="col">
                                    <small>
                                        ...
                                        @if($purchase->status == 0)
                                            <span class="badge bg-primary">{{ __(Workdo\Account\Entities\Bill::$statues[$purchase->status]) }}</span>
                                        @elseif($purchase->status == 1)
                                            <span class="badge bg-warning">{{ __(Workdo\Account\Entities\Bill::$statues[$purchase->status]) }}</span>
                                        @elseif($purchase->status == 2)
                                            <span class="badge bg-danger">{{ __(Workdo\Account\Entities\Bill::$statues[$purchase->status]) }}</span>
                                        @elseif($purchase->status == 3)
                                            <span class="badge bg-info">{{ __(Workdo\Account\Entities\Bill::$statues[$purchase->status]) }}</span>
                                        @elseif($purchase->status == 4)
                                            <span class="badge bg-success">{{ __(Workdo\Account\Entities\Bill::$statues[$purchase->status]) }}</span>
                                        @endif
                                    </small>
                                </div>
