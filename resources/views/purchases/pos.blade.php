                                    ...
                                    <div class="card-header card-body">
                                        ...
                                        <form id="setting-form" method="post" action="{{route('purchase.template.setting')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('purchase_template',Workdo\Account\Entities\AccountUtility::templateData()['templates'],isset($company_settings['purchase_template']) && !empty($company_settings['purchase_template']) ? $company_settings['purchase_template'] : null, array('class' => 'form-control choices','required'=>'required')) }}
                                            </div>
                                            <div class="form-group">
