                                ...
                                <div class="summery-footer">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b class="planpricetext "> <span class="final_price">{{ ($planprice > 0 ) ? super_currency_format_with_sym(0) : 'Free' }}</span></b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left"><h6 class="mb-0">{{ __('Workspace') }} <small
                                                class="text-muted workspace-price">{{ '( Per Workspace ' .  super_currency_format_with_sym($workspaceprice)  . ' )' }}</small></h6></span>
                                        ...
                                        <li>
                                            <span class="cart-sum-left"><h6 class="mb-0">{{ __('Users') }} <small
                                                class="text-muted user-price">{{ '( Per User ' . super_currency_format_with_sym($userprice) . ' )' }}</small></h6></span>
...
@push('scripts')
    ...
    <script>
        ...
        function SwitchChange()
        {
            ...
            $(".user-price").text('( Per User '+ formatCurrency(userprice,'{{ $admin_settings }}') +')');
            $(".userpricetext").text(formatCurrency(userpricetext,'{{ $admin_settings }}'));
            $(".workspace-price").text('( Per Workspace '+ formatCurrency(workspaceprice,'{{ $admin_settings }}') +')');
            $(".workspacepricetext").text(formatCurrency(workspacepricetext,'{{ $admin_settings }}'));
